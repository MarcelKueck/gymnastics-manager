  ...
  return (
    <div className="space-y-6">
      <div className="flex items-center justify-between">
        <div>
          <h1 className="text-3xl font-bold">Trainings verwalten</h1>
          <p className="text-muted-foreground">Wiederkehrende Trainings konfigurieren</p>
        </div>
            ...
            <Card key={training.id}>
                ...
                <div className="flex items-center justify-between">
                  ...
                  <div className="flex items-center space-x-2">
                    ...
                    >
                      ...
                      Gruppen ({training.groups.length})
                    </Button>
                    <Button
                      variant="outline"
                      size="sm"
              ...
              <CardContent>
                <div className="grid md:grid-cols-3 gap-4 text-sm">
                  <div>
                    <p className="text-muted-foreground">Wochentag</p>
                  ...
                  <div>
                    <p className="text-muted-foreground">Gruppen</p>
